    ...
    <div class="container">
        ...
        <asp:GridView ID="gv_browseImages" CssClass="table table-responsive" runat="server" AutoGenerateColumns="False">
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <a href="<%#"CommentViewer.aspx?imageID=" + Eval("imageID") %>"><asp:Image ID="img_Photo" CssClass="img_responsive" style="max-height:200px;" runat="server" ImageUrl='<%#"ImageViewerHandler.ashx?id=" + Eval("imageID")%>' /></a>
                    </ItemTemplate>
                </asp:TemplateField>
